...
*   🏗  Currently working on [`Pinoy Snacks Website`](https://github.com/michaela-austria/pinoy-snacks-DOM) implementing DOM API and Intersection Observer API using Vanilla JavaScript.
